  ...
  methods: {
    initMatrix() {
      ...
      let legend = this.svg
        ...
        .attr(
          "transform",
          `translate(${this.width - legendWidth * 2.5},${
            this.margin.top - legendHeight * 1.5
          })`
        );
      let colorScale = d3
        .scaleSequential()
    ...
    renderMatrix() {
      ...
      cells
        ...
        .attr(
          "d",
          `M ${0} ${-dy} L ${dx} ${-dy} L ${dx / 1.3} ${-dy / 1.3} L ${
            dx / 3
          } ${-dy / 1.3} Z`
        )
      ...
      cells
        ...
        .attr(
          "d",
          `M ${dx} ${-dy} L ${dx} ${0} L ${dx / 1.3} ${-dy / 3} L ${dx / 1.3} ${
            -dy / 1.3
          } Z`
        )
      ...
      cells
        ...
        .attr(
          "d",
          `M ${-dx} ${dy} L ${-dx} ${0} L ${-dx / 1.3} ${dy / 3} L ${
            -dx / 1.3
          } ${dy / 1.3} Z`
        )
        .attr("fill", (d) => colorScale(Math.sign(d.val) * 0.5));
